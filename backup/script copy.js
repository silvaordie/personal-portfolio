...
function populateNatureFilter() {
    const natureFilterSelect = document.getElementById("nature-filter");
    const natureSet = new Set();
    ...
    natureSet.forEach(nature => {
        const option = document.createElement("option");
        option.value = nature;
        option.textContent = nature;
        natureFilterSelect.appendChild(option);
    });
}

function populateTechnologyFilter() {
    const technologyFilterSelect = document.getElementById("technology-filter");
    ...
    technologyFilterSelect.innerHTML = '<option value="">Select Technology</option>';
    
    Array.from(technologySet).sort().forEach(tech => {
        const option = document.createElement("option");
        option.value = tech;
        option.textContent = tech;
        technologyFilterSelect.appendChild(option);
    });
}

function populateToolsFilter() {
    const toolsFilterSelect = document.getElementById("tools-filter");
    ...
    toolsFilterSelect.innerHTML = '<option value="">Select Tools</option>';
    
    Array.from(toolsSet).sort().forEach(tool => {
        const option = document.createElement("option");
        option.value = tool;
        option.textContent = tool;
        toolsFilterSelect.appendChild(option);
    });
}
...
function filterProjects() {
    ...
    displayProjects(filteredProjects, colorData);
}

function displayProjects(filteredProjects = projects, colorData) {
